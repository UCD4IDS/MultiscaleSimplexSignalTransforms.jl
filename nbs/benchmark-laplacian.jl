...
# ╔═╡ 8c042790-1ebb-11ed-01c6-874c7513346a
begin
	using Pkg
	dev = Pkg.develop
	dev(path="..")
...
# ╔═╡ 9cd48f2b-a9de-4ab3-8095-daaf963386ba
using Revise

# ╔═╡ 3f2e9964-dab0-4542-9420-52e9b8639a80
using MultiscaleSimplexSignalTransforms

# ╔═╡ 186d092b-8f1f-4bd2-a61e-2bc2b3d648e7
using Graphs, BenchmarkTools, SparseArrays

# ╔═╡ 8f574c8c-f495-413c-a2fa-85dc049fd1bc
gs = simplex_path(20); g = gs[1]

# ╔═╡ 196aee3c-aafa-477f-818d-96c7cf3dc360
A = adjacency_matrix(g)

# ╔═╡ 88b8cf10-6686-4c1c-821a-1cbc59c8ee6e
zip(findnz(A)[1:2]...) |> collect
...
manifest_format = "2.0"
project_hash = "c5d75fb1b15a2e50c2dd63dfc9c6b2fb7f45c13a"
