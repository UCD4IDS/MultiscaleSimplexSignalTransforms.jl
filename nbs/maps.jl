...
# ╔═╡ 663796a6-4b22-11ed-033d-1b90d97a9506
using LightOSM

# ╔═╡ 3e513eb3-6043-4bfa-a662-ecce3e6ba4bb
using CairoMakie, OSMMakie

# ╔═╡ 82e322dd-70bd-4c62-a2f8-1a737e6cefba
mapcode, place_name = (:minnesota, "Minnesota")

# ╔═╡ 3fa2f7ba-3046-4f3c-bdda-f3e31fb9ee38
map_path = "../data/$mapcode.json"

# ╔═╡ 732e6092-835f-4ab8-8272-1fc232d170c7
if !isfile(map_path)
	download_osm_network(
		:place_name;
		place_name,
		save_to_file_location="../data/$mapcode.json"
	)
else
	println("already got it")
end

# ╔═╡ fdc5b640-229e-4df8-84b1-440bdf670471
g = graph_from_file("../data/$mapcode.json")

# ╔═╡ a9975b0e-5028-4cf7-b46c-e6fd0fc80082
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "6bfd17bd873c03147505ce8811155555c1556055"
...
git-tree-sha1 = "cf6775006831f0a760e1060cc0badf15f2ee2028"
