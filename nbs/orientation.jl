...
# ╔═╡ dea7cd82-feff-11ec-2660-77e51ad513b6
begin
	using Revise
...
# ╔═╡ 4ff5bb62-012a-4300-8852-fbe10c3cb336
using Graphs, Plots, LinearAlgebra, LaTeXStrings

# ╔═╡ 25a5d8bf-e989-4d56-bdb1-b9e24777b62a
using IterTools

# ╔═╡ fce0e8c0-9e12-4302-9bc5-548c90a1601f
gs = simplex_path(10); g, x, y = gs

# ╔═╡ 768db534-c13d-4510-8174-05024ca00070
plotg(
	gs...;
	elo=.15,
	edgemargin=60
...
path = "../../../../../../../Users/hyperion/.julia/dev/MultiscaleSimplexSignalTransforms"
