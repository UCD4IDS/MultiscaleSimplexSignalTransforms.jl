...
# ╔═╡ 26f80301-8573-4693-bd1d-3d92347ac9ca
begin
	using Pkg
	pkgadd = Pkg.add
	pkgadd(url="https://github.com/piever/PersistentCohomology.jl.git")
end

# ╔═╡ be00b25b-a888-4870-abe2-663d0ad53cd4
using Graphs, SimpleWeightedGraphs, Plots, LinearAlgebra, LaTeXStrings, Arpack, SparseArrays, Clustering, InvertedIndices, DataStructures, MAT, StatsBase


# ╔═╡ 2d544075-5e2a-4112-9211-9c4dbd5f879a
using PersistentCohomology

# ╔═╡ e46dd345-6fd2-4318-981e-fa6a96ea4f2e
begin
...
# ╔═╡ 5a0e254b-be98-497e-a5f0-e5b51a64cd92
cplx = vietorisrips(adjacency_matrix(g), 10)

# ╔═╡ c50ff781-4dd6-4522-ba58-f1bf9bf1c07e
length.(cplx)
...
PersistentCohomology = "1871bf54-ef79-537f-b0b4-1ef9038f9ab8"
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "d89d4ba294a50fc33164d5b1976881256421f2fe"
...
repo-rev = "master"
repo-url = "https://github.com/piever/PersistentCohomology.jl.git"
