...
# ╔═╡ 6c530022-af8f-11ec-0b4f-6f51e6ce36df
using Plots, GraphRecipes, SparseArrays

# ╔═╡ 6c116ae8-f55a-429f-b7cb-68cef1f20b58
using Graphs, ParserCombinator, GraphIO

# ╔═╡ 21ab628a-432b-4613-9304-6672fc5c3440
default(size=(1000, 100))

# ╔═╡ 5f02c048-b2a6-4db4-aca7-93cda8664b7b
n = 5; n, ms = n, (n+30)/80

# ╔═╡ f65d8dca-9c14-40b8-a4a4-3276c6f06ab9
graphplot(
...
# ╔═╡ 7f3fae32-ec48-4788-bcf2-72bdc913a6b4
g = loadgraph("/Users/eug/Downloads/polblogs.gml", "digraph", GMLFormat())

# ╔═╡ 89942384-5774-4846-b51c-32d4faf0b9ca
W = adjacency_matrix(g); spy(W, size = (1000,1000))

# ╔═╡ 3cde7a45-571d-4570-a099-a80668e4da61
nnz(W-W')
