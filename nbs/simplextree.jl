...
# ╔═╡ 5a2f1f14-5bb7-11ed-0ab0-399118be9e93
begin
	using Pkg
	dev = Pkg.develop
	dev(path="..")
...
# ╔═╡ 1758abb0-ab54-4a4b-9c7b-dd9c0903499d
using Revise

# ╔═╡ 7b70a118-2dab-45f9-9180-a9ca0dbb4164
using MultiscaleSimplexSignalTransforms

# ╔═╡ 8cf82a04-61ab-4063-8aff-d41365bebf6c
...
# ╔═╡ bfe266a1-9d00-4c9b-a840-c339a959e573
a = SimplexTree(5)

# ╔═╡ 59906d34-694d-40a0-85a1-2ace2feeefa8
insert!(a, [1,2,3,4])

# ╔═╡ 731bb567-ae89-4251-9d02-0a186c7ddcc6
insert!(a, [2, 3, 4, 5])

# ╔═╡ 7f25bf53-b416-4dfc-94c6-18c2726023bd
simplices(a)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "b69588d87623dcc67316ca98299cb52e3dc9fbdd"
